...
//		checkRole(user);
    ...
    @Override
    public List<SysUserEntity> listClub() {

		return baseMapper.listClub();
    }

	@Override
	public PageUtils listClubUser(Map<String, Object> params) {
		Long acId = ShiroUtils.getUserEntity().getAcId();
		String username = (String)params.get("username");
		IPage<SysUserEntity> iPage = new Query<SysUserEntity>().getPage(params);
		IPage<SysUserEntity> page = baseMapper.listClubUser(iPage,username,acId);
